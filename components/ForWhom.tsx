...
const types = [
  {
    ...
    body: "Du stehst vor einer Entscheidung mit echtem Gewicht — vielleicht mit Familie, Kapital oder einem ganzen Lebensmodell im Gepäck. Und jedes Jahr, das du am falschen Ort verbringst, kostet dich etwas, das du nie zurückbekommst: Zeit. Bauchgefühl reicht hier nicht. Das Deep-Dive Reading gibt dir Entscheidungssicherheit auf Basis deines Horoskops — konkret, präzise, umsetzbar. Kein anderes Angebot geht so tief.",
  ...
  },
  {
    ...
    body: "Du reist bewusst — und kennst dieses Gefühl, wenn ein Ort dich auf eine Weise berührt, die du nicht ganz erklären kannst. Stell dir vor, du wüsstest vorher, welcher Ort das sein wird. Mit Astrokartographie lernst du, diese Orte gezielt zu wählen: für Energie, Klarheit, Leichtigkeit oder Neuanfänge. Schnell umsetzbar, sofort anwendbar.",
