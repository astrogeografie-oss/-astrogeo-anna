...
const types = [
  {
    ...
    body: "Du fühlst, dass du feststeckst — aber kannst es vielleicht noch nicht klar benennen. Vielleicht ist es der Ort, der dich bremst. Vielleicht die Energie deines Zuhauses. Der erste Schritt muss nicht groß sein — er muss nur richtig sein.",
  ...
  },
  {
    ...
    body: "Du reist bewusst — und weißt, dass manche Orte dich auf eine Weise berühren, die du nicht ganz erklären kannst. Mit Astrokartographie lernst du, diese Orte gezielt zu wählen: für Energie, Klarheit, Leichtigkeit oder Neuanfänge.",
  ...
  },
  {
    ...
    body: "Du stehst vor einer der größten Entscheidungen deines Lebens. Ein neuer Ort, ein neues Kapitel. Hier brauchst du keine Inspiration — du brauchst Präzision. Das Deep-Dive Reading gibt dir Entscheidungssicherheit, die bleibt.",
