  ...
  return (
    <div className="min-h-screen" style={{ background: "#faf7f2" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-12">
        ...
        <p className="font-[family-name:var(--font-cormorant)] text-xl text-[#1c1008] font-light leading-relaxed max-w-2xl">
          ...
          <Link key={post.slug} href={`/blog/${post.slug}`} className="group block">
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="md:w-28 flex-shrink-0 flex flex-col items-start gap-2">
                  <span
                    className="inline-block px-3 py-1 font-[family-name:var(--font-montserrat)] text-xs tracking-[0.25em] text-[#3d2800] uppercase rounded-sm whitespace-nowrap"
                ...
                <div className="flex-1">
                  <h2 className="font-[family-name:var(--font-cormorant)] text-3xl font-light text-[#100802] leading-[1.2] mb-1 group-hover:text-[#b8922e] transition-colors duration-300">
                    {post.title}
                  </h2>
                  <p className="font-[family-name:var(--font-cormorant)] text-lg text-[#3d2800] italic font-light mb-4">
                    {post.subtitle}
                  </p>
                  <p className="font-[family-name:var(--font-cormorant)] text-base text-[#1c1008] font-light leading-relaxed line-clamp-3">
                    {post.intro}
                  </p>
